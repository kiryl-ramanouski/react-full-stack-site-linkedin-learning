const HomePage = () => {
  return (
    <>
      <h1 className='header'>Hello, welcome to my blog!</h1>
      <p className='main-text'>
        Welcome to my blog! Sometimes that's just the way it has to be. Sure,
        there were probably other options, but he didn't let them enter his
